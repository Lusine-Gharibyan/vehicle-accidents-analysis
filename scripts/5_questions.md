...
This document outlines the business questions explored in this project.
The analysis is structured across three analytical levels:
...
- Which vehicle age groups contribute most to each severity level?
